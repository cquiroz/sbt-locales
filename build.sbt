...
def scalaNativeScala212Version(v: String) = if (v.startsWith("2.12.")) "2.12.15" else v
...
lazy val api = crossProject(JSPlatform, JVMPlatform, NativePlatform)
  ...
  .settings(
    name := "cldr-api",
    scalaVersion := "2.12.15", // needs to match the version for sbt
    description := "scala-java-locales cldrl api",
    crossScalaVersions := Seq("2.11.12", "2.12.15", "2.13.4", "3.0.0-RC3", "3.0.0"),
